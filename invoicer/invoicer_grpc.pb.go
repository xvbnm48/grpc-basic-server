...
type InvoicerClient interface {
	Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*ResponseRequest, error)
}
...
func (c *invoicerClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*ResponseRequest, error) {
...
type InvoicerServer interface {
	Create(context.Context, *CreateRequest) (*ResponseRequest, error)
...
func (UnimplementedInvoicerServer) Create(context.Context, *CreateRequest) (*ResponseRequest, error) {
